...
plt.scatter(x2.ravel(), y2.ravel(), c=pred, s=10,
            cmap=cmap, label='Linear prediction on grid')

plt.scatter(X1[:, 0], X1[:, 1], c=Y1, s=50, cmap=cmap,
            ec='black', label='Given values')
...
plt.scatter(x2.ravel(), y2.ravel(), c=pred, s=10,
            cmap=cmap, label='rbf prediction on grid')
